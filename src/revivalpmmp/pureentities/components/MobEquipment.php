...
class MobEquipment{
	...
	private function createArmorEquipPacket() : MobArmorEquipmentPacket{
		...
		$pk->head = $this->helmet !== null ? $this->helmet : Item::get(ItemIds::AIR),
		$pk->chest = $this->chestplate !== null ? $this->chestplate : Item::get(ItemIds::AIR),
		$pk->legs = $this->leggings !== null ? $this->leggings : Item::get(ItemIds::AIR),
		$pk-feet = $this->boots !== null ? $this->boots : Item::get(ItemIds::AIR)
		];
		$pk->encode();
		$pk->isEncoded = true;
		return $pk;
